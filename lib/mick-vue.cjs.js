...
var hasChanged = function (val, newval) {
...
var RefTmpl = /** @class */ (function () {
    function RefTmpl(value) {
        this.__v_isRef = true;
    ...
    Object.defineProperty(RefTmpl.prototype, "value", {
        get: function () {
            if (isTracking()) {
                trackRefValue(this);
            }
